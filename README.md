...
| Scalar mod ℓ        | `scalarImplementation` (planned; `sub_val_spec` ✅, `L_val`, loop specs proven)   | 🔨 sub done · add/mul next | denotation + L=ℓ + FULL sub (⟦sub a b⟧=⟦a⟧−⟦b⟧ in ZMod ℓ) proven; add & Montgomery mul next |
