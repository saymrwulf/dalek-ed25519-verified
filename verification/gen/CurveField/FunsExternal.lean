...
/-- [curve25519_dalek::edwards::affine::{impl subtle::ConditionallySelectable for curve25519_dalek::edwards::affine::AffinePoint}::conditional_assign]:
    Source: 'curve25519-dalek/src/edwards/affine.rs', lines 23:0-30:1
    Visibility: public -/
axiom
...
/-- [curve25519_dalek::edwards::affine::{impl core::cmp::Eq for curve25519_dalek::edwards::affine::AffinePoint}::assert_fields_are_eq]:
